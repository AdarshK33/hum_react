...
function ViewShift() {
  ...
  const totalRecords =
    searchShift !== undefined && searchShift !== null && searchShift.length;
  const pageRange = 10;
  ...
  const currentRecords =
    searchShift !== undefined && searchShift !== null
      ? searchShift.slice(indexOfFirstRecord, indexOfLastRecord)
      : [];
  ...
  useEffect(() => {
    if (
      searchShiftList !== undefined &&
      searchShiftList !== null &&
      searchShiftList.length > 0
    ) {
                        ...
                        <tbody key={i + 1}>
                          <tr>
                            ...
                            <td>
                              ...
                              {moment(e.endTime, ["h:mm A"]).format("HH:mm")}
                            </td>

                            <td>{e.workingHours}</td>
                            <td>
                              {moment(e.breakStartTime, ["h:mm A"]).format(
                                "HH:mm"
                              )}
                              -
                              {moment(e.breakEndTime, ["h:mm A"]).format(
                                "HH:mm"
                              )}
                            </td>
