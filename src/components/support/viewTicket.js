...
const ViewTicket = () => {
  ...
  const uploadDailyQty = (file, text) => {
    ...
    return client
      .post("/api/v1/ticket/upload", formData)
      .then((response) => {
        ...
        {loader === true ? (
          ...
          <Form style={{ backgroundColor: "white", padding: "3rem" }}>
                ...
                <Form.Group as={Row}>
                  ...
                  <Col sm="8">
                    <Form.Control
                      type="text"
                      value={
                        ticketIdList.firstName + " " + ticketIdList.lastName
                      }
                      readOnly
                      className="disabledValue blueText"
                    />
            ...
            <Row>
              <Col sm={8}>
                <Form.Group as={Row}>
                  <Form.Label column sm="3" className="labels">
                    Phone Number :
                  </Form.Label>
                  <Col sm="9">
                    <Form.Control
                      type="text"
                      value={ticketIdList.phoneNumber}
                      readOnly
                ...
                <Form.Group as={Row}>
                  ...
                  <Col sm="9">
                    <Form.Control
                      ...
                      className="disabledValue"
                      value={
                        ticketIdList.categoryId === 1
                          ? "User Interface Issue"
                          : ticketIdList.categoryId === 2
                          ? "Performance Issue"
                          : ticketIdList.categoryId === 3
                          ? "Leave Functionality/Feature Issue"
                          : ticketIdList.categoryId === 4
                          ? "Enhancement suggestions"
                          : ticketIdList.categoryId === 5
                          ? "Data mismatch"
                          : ticketIdList.categoryId === 6
                          ? "Roster Functionality/Feature Issue"
                          : ticketIdList.categoryId === 7
                          ? "Report Extract Issue"
                          : ticketIdList.categoryId === 8
                          ? "Salary Calculation Issue"
                          : ticketIdList.categoryId === 9
                          ? "Leave Calculation Issue"
                          : ticketIdList.categoryId === 10
              ...
              <Col sm={8}>
                <Form.Group as={Row}>
                  ...
                  <Col sm="9">
                    <Form.Control
                      type="text"
                      value={ticketIdList.description}
                      readOnly
                      className="disabledValue"
                    />
                  </Col>
                ...
                <Form.Group as={Row}>
                  ...
                  <Col sm="9">
                    <Form.Control
                      ...
                      className="disabledValue"
                      value={
                        ticketIdList.urgencyId === 1
                          ? "I am blocked from doing my work"
                          : ticketIdList.urgencyId === 2
                          ? "The issue partially blocks my work"
                          : ticketIdList.urgencyId === 3
                          ? "This issue disrupts my work"
                          : ticketIdList.urgencyId === 4
                          ? "I can continue work"
                          : ""
                      }
                    />
                ...
                <Form.Group as={Row}>
                  ...
                  <Col sm="9">
                    <Form.Control
                      ...
                      className="disabledValue"
                      value={
                        ticketIdList.priorityId === 1
                          ? "Critical"
                          : ticketIdList.priorityId === 2
                          ? "High"
                          : ticketIdList.priorityId === 3
                          ? "High"
                          : ticketIdList.priorityId === 4
                          ? "Medium"
                          : ticketIdList.priorityId === 5
                          ? "High"
                          : ticketIdList.priorityId === 6
                          ? "High"
                          : ticketIdList.priorityId === 7
                          ? "Medium"
                          : ticketIdList.priorityId === 8
                          ? "Medium"
                          : ticketIdList.priorityId === 9
                          ? "High"
                          : ticketIdList.priorityId === 10
                          ? "Medium"
                          : ticketIdList.priorityId === 11
                          ? "Medium"
                          : ticketIdList.priorityId === 12
                          ? "Low"
                          : ticketIdList.priorityId === 13
                          ? "Medium"
                          : ticketIdList.priorityId === 14
                          ? "Medium"
                          : ticketIdList.priorityId === 15
                          ? "Low"
                          : ticketIdList.priorityId === 16
                          ? "Low"
                          : ""
                      }
                    />
                  ...
                  <Col sm="9">
                    ...
                    {ticketIdList.ticketStatus === 3 ? (
                      <Form.Control
                        ...
                        className="disabledValue"
                        value={
                          ticketIdList.completionStatus === 0
                            ? "Fulfilled Offline"
                            : ticketIdList.completionStatus === 1
                            ? "Fulfilled by live support"
                            : ticketIdList.completionStatus === 2
                            ? "Abandoned by User"
                            : ticketIdList.completionStatus === 3
                            ? "Enhancement request"
                            : ticketIdList.completionStatus === 4
                            ? "Resolved by Workaround"
                            : ticketIdList.completionStatus === 5
                            ? "Training"
                            : ""
                        }
                      />
                  ...
                  <Form.Group as={Row}>
                    ...
                    <Col sm="4">
                      <button
                        ...
                        type="button"
                        onClick={() => handleUpload("first")}
                        disabled={fileSubmitButtonFirst}
                      >
                        Upload
                      </button>
                      ...
                      <div style={{ paddingTop: "5px", float: "right" }}>
                        ...
                        <MinusCircle
                          style={{ color: "#376ebb" }}
                          onClick={() => handleRemoveUpload("first")}
                        />
                      </div>
                    </Col>
                  ...
                  <Form.Group as={Row}>
                    ...
                    <Col sm="4">
                      <button
                        ...
                        type="button"
                        onClick={() => handleUpload("second")}
                        disabled={fileSubmitButtonSecond}
                      >
                        Upload
                      </button>
                  ...
                  <Form.Group as={Row}>
                    ...
                    <Col sm="4">
                      <button
                        ...
                        type="button"
                        onClick={() => handleUpload("third")}
                        disabled={fileSubmitButtonThird}
                      >
                        Upload
                      </button>
