...
const InActiveEmployeeHistoryList = (props) => {
  const {
  ...
  const handlePageChange = (pageNumber) => {
    ...
    setCurrentPage(pageNumber);
      ViewEmployeeHistoryData(fromDate,toDate,searchValue, pageNumber-1,role,0);
  ...
  const searchDataHandler = () => {
    ...
    setCurrentPage(1);
    if (searchValue !== "") {
      ViewEmployeeHistoryData(fromDate,toDate,searchValue, pageCount,role,0);
    } else {
      ViewEmployeeHistoryData(fromDate,toDate,searchValue, pageCount,role,0);
    }
  };
                ...
                <Table id="table-to-xls" className="table table-hover">
                  ...
                  >
                    <tr>
                      ...
                      <th scope="col">Exit Initiated By</th>
                      <th scope="col">Exit Initiated On</th>
                        ...
                        <tbody key={item.employeeId}>
                          <tr>
                           ...
                           <td>{item.exitInitiatedOn !== null && 
                            ...
                            <td>{item.fandFStatus}</td>
                             <td> <Link to={"/master-history/" + item.employeeId}>
...
export default InActiveEmployeeHistoryList;
