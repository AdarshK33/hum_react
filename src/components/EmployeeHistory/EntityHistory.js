...
console.log(dates)
    ...
    const totalRecords = entityTransferData !== null && entityTransferData !== undefined && entityTransferData.length;
    const pageRange = 10;

    const indexOfLastRecord = currentPage * recordPerPage;
    const indexOfFirstRecord = indexOfLastRecord - recordPerPage;
    const currentRecords = entityTransferData !== null && entityTransferData !== undefined ? entityTransferData.slice(indexOfFirstRecord, indexOfLastRecord) : [];
    ...
    return (
        <Fragment>
            ...
            {entityTransferData !== null && entityTransferData !== undefined && entityTransferData.length > 10 &&
                <Pagination
                    itemClass="page-item"
                    linkClass="page-link"
