...
console.log(dates)
    ...
    const totalRecords = costCenterData !== null && costCenterData !== undefined && costCenterData.length;
    const pageRange = 10;

    const indexOfLastRecord = currentPage * recordPerPage;
    const indexOfFirstRecord = indexOfLastRecord - recordPerPage;
    const currentRecords = costCenterData !== null && costCenterData !== undefined ? costCenterData.slice(indexOfFirstRecord, indexOfLastRecord) : [];
    ...
    return (
        <Fragment>
            ...
            {costCenterData !== null && costCenterData !== undefined && costCenterData.length > 10 &&
                <Pagination
                    itemClass="page-item"
                    linkClass="page-link"
