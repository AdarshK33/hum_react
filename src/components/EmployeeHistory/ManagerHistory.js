...
console.log(dates)
    ...
    const totalRecords = managerData !== null && managerData !== undefined && managerData.length;
    const pageRange = 10;

    const indexOfLastRecord = currentPage * recordPerPage;
    const indexOfFirstRecord = indexOfLastRecord - recordPerPage;
    const currentRecords = managerData !== null && managerData !== undefined ? managerData.slice(indexOfFirstRecord, indexOfLastRecord) : [];
    ...
    return (
        <Fragment>
            ...
            {managerData !== null && managerData !== undefined && managerData.length > 10 &&
                <Pagination
                    itemClass="page-item"
                    linkClass="page-link"
