...
console.log(dates)
    ...
    const totalRecords = bonusData !== null && bonusData !== undefined && bonusData.length;
    const pageRange = 10;

    const indexOfLastRecord = currentPage * recordPerPage;
    const indexOfFirstRecord = indexOfLastRecord - recordPerPage;
    const currentRecords = bonusData !== null && bonusData !== undefined ? bonusData.slice(indexOfFirstRecord, indexOfLastRecord) : [];
    ...
    return (
        <Fragment>
            ...
            {bonusData !== null && bonusData !== undefined && bonusData.length > 10 &&
                <Pagination
                    itemClass="page-item"
                    linkClass="page-link"
