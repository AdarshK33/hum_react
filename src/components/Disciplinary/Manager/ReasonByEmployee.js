      ...
      {typeof disciplinarySearchData !== undefined ? (
        <Fragment>
          ...
          <div className=" ">
            ...
            <br></br>
            <p>
              <b>Sub:</b> Reply to the Show Cause Notice issue Date {moment().format("DD-MM-YYYY")}
            </p>
          <p>
          I would to explain my response towards the show cause issued
           on {disciplinarySearchData.disciplinaryAction.actionIssuedDate} and here is my explanation to the same.
          </p>
              <br />
