      ...
      {true ? (
        <Fragment>
          ...
          <div className=" ">
            ...
            Survey No. 78/10, A2 – 0 Chikkajala Village, Bellary Road, Bangalore 562157,
             KA, IN, at its XXXXXXXX located at {" "}
              ...
              On XXXXXXX, Decathlon issued to you a Show Cause notice,
            asking you for a clear written explanation regarding the following accusations – 
                • ( mention it from Show cause)
              <br />
             ...
             activities and follow the right process of the company. 
             It is expected that henceforth,
              there will be no occasions for such complaints in future otherwise 
              appropriate disciplinary action will follow Please note,
              the Company reserves the right to take appropriate action with respect to 
              any repetition of similar act.
              <br />
              <br />
              <br />
              <br />
