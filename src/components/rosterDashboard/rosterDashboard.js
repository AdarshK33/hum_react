...
const RosterDashboard = () => {
  ...
  useEffect(() => {
    ...
    if (costCenterList && costCenterList.length) {
      ...
      if (costCenter1) {
        ...
        setCostCenter1(costCenterList[0].costCentreName);
        adminRosterCalculateUtilisation(
          costCenterList[0].costCentreName,
          currentMonth,
          currentYear
        );
      }
  ...
  const options1 = {
    ...
    data: {
      utilisedValue:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[0].utilisedValue
          : "null",
      utilised:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[0].utilised
          : "null",
      unUtilisedValue:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[0].unUtilisedValue
          : "null",
      unUtilised:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[0].unUtilised
          : "null",
  ...
  const options2 = {
    ...
    data: {
      utilisedValue:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[1].utilisedValue
          : "null",
      utilised:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[1].utilised
          : "null",
      unUtilisedValue:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[1].unUtilisedValue
          : "null",
      unUtilised:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[1].unUtilised
          : "null",
  ...
  const options3 = {
    ...
    data: {
      utilisedValue:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[2].utilisedValue
          : "null",
      utilised:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[2].utilised
          : "null",
      unUtilisedValue:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[2].unUtilisedValue
          : "null",
      unUtilised:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[2].unUtilised
          : "null",
  ...
  const options4 = {
    ...
    data: {
      utilisedValue:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[3].utilisedValue
          : "null",
      utilised:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[3].utilised
          : "null",
      unUtilisedValue:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[3].unUtilisedValue
          : "null",
      unUtilised:
        adminRosterCalculateUtilisationList &&
        adminRosterCalculateUtilisationList.length
          ? adminRosterCalculateUtilisationList[3].unUtilised
          : "null",
  ...
  return (
    <Fragment>
      <Container style={{ paddingBottom: "30px", marginTop: "10%" }}>
        <Row
          className="costCenter-row"
          style={{
            margin: "10px 0px",
            paddingTop: "10px",
            display: "flex",
        ...
        <Row>
          <Col sm={12}>
            <Card className="big-card p-30 main-card">
              <h2 className="roster-center">
                {adminRosterCalculateUtilisationList &&
                adminRosterCalculateUtilisationList.length
                  ? adminRosterCalculateUtilisationList[3].utilisationType +
                    " Utilisation"
                  : "Overall Utilisation"}
              </h2>
              {/* {console.log(adminRosterCalculateUtilisationList, 'adminRosterCalculateUtilisationList')} */}
              {options4.data.utilisedValue > 0 ||
              options4.data.unUtilisedValue > 0 ? (
                <Chart
                  chartType="PieChart"
                  data={[
                    ["Utilisation", "hrs"],
                    [
                      `Utilised ${options4.data.utilisedValue} hrs (${options4.data.utilised})`,
                      options4.data.utilisedValue,
                    ],
                    [
                      `Unutilised ${options4.data.unUtilisedValue} hrs (${options4.data.unUtilised})`,
                      options4.data.unUtilisedValue,
                    ],
        ...
        <Row>
          <Col sm={4} px={0}>
            <Card className="small-card1 p-10 small-card">
              <h4 className="roster-center">
                {adminRosterCalculateUtilisationList &&
                adminRosterCalculateUtilisationList.length
                  ? adminRosterCalculateUtilisationList[0].utilisationType +
                    " Utilisation"
                  : "Permanent Utilisation"}
              </h4>
              {options1.data.utilisedValue > 0 ||
              options1.data.unUtilisedValue > 0 ? (
                <Chart
                  chartType="PieChart"
                  data={[
                    ["Utilisation", "hrs"],
                    [
                      `Utilised ${options1.data.utilisedValue} hrs (${options1.data.utilised})`,
                      options1.data.utilisedValue,
                    ],
                    [
                      `Unutilised ${options1.data.unUtilisedValue} hrs (${options1.data.unUtilised})`,
                      options1.data.unUtilisedValue,
                    ],
          ...
          <Col sm={4} px={0}>
            <Card className="small-card2 p-10 small-card">
              <h4 className="roster-center">
                {adminRosterCalculateUtilisationList &&
                adminRosterCalculateUtilisationList.length
                  ? adminRosterCalculateUtilisationList[1].utilisationType +
                    " Utilisation"
                  : "Part Time Utilisation"}
              </h4>
              {options2.data.utilisedValue > 0 ||
              options2.data.unUtilisedValue > 0 ? (
                <Chart
                  chartType="PieChart"
                  data={[
                    ["Utilisation", "hrs"],
                    [
                      `Utilised ${options2.data.utilisedValue} hrs (${options2.data.utilised})`,
                      options2.data.utilisedValue,
                    ],
                    [
                      `Unutilised ${options2.data.unUtilisedValue} hrs (${options2.data.unUtilised})`,
                      options2.data.unUtilisedValue,
                    ],
          ...
          <Col sm={4} px={0}>
            <Card className="small-card3 p-10 small-card">
              <h4 className="roster-center">
                {adminRosterCalculateUtilisationList &&
                adminRosterCalculateUtilisationList.length
                  ? adminRosterCalculateUtilisationList[2].utilisationType +
                    " Utilisation"
                  : "Internship Utilisation"}
              </h4>
              {options3.data.utilisedValue > 0 ||
              options3.data.unUtilisedValue > 0 ? (
                <Chart
                  chartType="PieChart"
                  data={[
                    ["Utilisation", "hrs"],
                    [
                      `Utilised ${options3.data.utilisedValue} hrs (${options3.data.utilised})`,
                      options3.data.utilisedValue,
                    ],
                    [
                      `Unutilised ${options3.data.unUtilisedValue} hrs (${options3.data.unUtilised})`,
                      options3.data.unUtilisedValue,
                    ],
