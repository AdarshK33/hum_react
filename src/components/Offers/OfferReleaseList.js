                    ...
                    <Col sm={12}>
                        <div className="card" style={{ overflowX: "auto" }}>
                            ...
                            <div className="job-filter">
                                ...
                                <Link to='/manager-offer-release'><Button className="apply-button btn btn-light mr-2">Initate Offer</Button></Link>
                            </div>
                            <div className="table-responsive">
                                <Table id="table-to-xls" className="table table-hover">
                                    ...
                                    {loader === true && candidateList !== null && candidateList !== undefined ?
                                        <tbody>
                                            <tr>
                                                <td colSpan='12'>
                                        ...
                                        :
                                        candidateList !== undefined && candidateList !== null &&
