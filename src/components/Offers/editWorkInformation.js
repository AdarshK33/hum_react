                ...
                <Row>
                    <Col sm={3}>
                        <Form.Group>
                            ...
                            <Form.Control type='text' value={user.company} className='form-input'
                    ...
                    <Col sm={3}>
                        <Form.Group className='reactDate'>
                            ...
                            onChange={(e) => dateOfJoiningHandler(e)} dateFormat="yyyy-MM-dd" 
                            placeholderText='Date of Joining' disabled={disabled} />
                        </Form.Group>
                    </Col>
                    <Col sm={3}>
                        <Form.Group>
                ...
                <Row>
                    ...
                    <Col sm={3}>
                        <Form.Group>
                            ...
                            <Form.Control type='text' value={locationName.cityName} className='form-input'
                             readOnly />
                        </Form.Group>
                    </Col>
                ...
                <Row>
                    <Col sm={12}>
                        <Form.Group>
                            ...
                            <Form.Control type='text' value={state.ngoDetail} className='form-input' disabled={disabled}
