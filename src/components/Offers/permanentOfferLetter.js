...
const PermanentOfferLetter = () => {
  ...
  return (
    <Fragment>
      ...
      <p className="offerSubHeader">Date: {moment().format("DD-MM-YYYY")}</p>
      <p>Dear {offerLetterData.candidateName},</p>
      <p>
        We have the pleasure to offer you the position of{" "}
        <span className="boldText">{offerLetterData.position}</span> on FullTime
        Basis, at Prodin Sporting Pvt. Ltd.{" "}
      </p>
      <br></br>
      ...
      <ol>
        <li>
          You will report to{" "}
          <span className="boldText">{offerLetterData.managerName}</span> or any
          officer appointed by him/her on{" "}
          {offerLetterData.permanentCandidateOffer.effectiveDate}
        </li>
        <li>
          Your monthly gross salary will not exceed Rs.{" "}
          <span className="boldText">{offerLetterData.fixedGross}</span>. Refer
          to the salary annexure mentioned below
        </li>
        <li>
          You may also receive a bonus on monthly basis and which would be to a
          maximum of 20.0 % of your monthly gross salary.Your manager will
          explain to you the calculation of such bonus
        </li>
        <li>
          Please note that salary and bonus payments are made based on
          individual merits and therefore such matters should be kept strictly
          confidential to yourself only
        </li>
        <li>
          Changes in your compensation are subject to the discretion of the
          Company and will be subject to and be on the basis of your effective
          performance and results during your employment and other relevant
          criteria
        </li>
        <li>
          You will be on probation for a period of 3 month(s) from the date of
        ...
        <Table bordered size="sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{Math.round(offerLetterData.permanentCandidateOffer.lta)}</td>
              <td>
                {Math.round(offerLetterData.permanentCandidateOffer.lta * 12)}
              </td>
              <td>
                {Math.round(
            ...
            <tr>
              ...
              <td>
                {Math.round(
                  offerLetterData.permanentCandidateOffer.specialAllowance * 12
                )}
              </td>
              <td>
                {Math.round(
            ...
            <tr>
              ...
              <td>-</td>
              <td>
                {Math.round(offerLetterData.permanentCandidateOffer.bonus)}
              </td>
              <td>
                {Math.round(offerLetterData.permanentCandidateOffer.bonus * 12)}
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>PF </td>
              <td>
                {Math.round(offerLetterData.permanentCandidateOffer.employerPF)}
              </td>
              <td>
                {Math.round(
            ...
            <tr>
              <td>Gratuity </td>
              <td>
                {Math.round(offerLetterData.permanentCandidateOffer.gratuity)}
              </td>
              <td>
                {Math.round(
            ...
            <tr>
              ...
              <td className="boldText">
                {Math.round(offerLetterData.permanentCandidateOffer.ctc * 12)}
              </td>
              <td className="boldText">
                {Math.round(
