  ...
  const submitHandler = (e) => {
    ...
    if (HolidayValidation() === true) {
      if (
        ...
        let data = {
          department: HolidaysList[0].department,
          holidayDate: HolidaysList[0].holidayDate,
          holidayId: HolidayId,
          holidayName: HolidayName,
          state: HolidaysList[0].state,
          stateId: HolidaysList[0].stateId,
          year: HolidaysList[0].year,
        };
