...
const AdminSalaryEdit = (props) => {
    ...
    return val2.map((el, i) => (
      <div key={i}>
        ...
        <input
          ...
          max={lastDate}
          required
          onChange={(e) => setSelectDateHandler(e, i)}
          value={el || ""}
        />
        <br />
      </div>
  ...
  function handleChange(e, i) {
    ...
    total = item_values.reduce(function (
      previousValue,
      currentValue,
      index,
      array
  ...
  const onSubmit = (e) => {
    ...
    const salaryData = {
      ...
      contractType: props.contractTypeList,
      year: year,
    };
  ...
  console.log("edit contract type admin", contractType);
  console.log("edit props.contract type admin", props.contractTypeList);
  return (
    <React.Fragment>
      <ToastContainer />
        ...
        <Container style={{ paddingBottom: "1rem" }}>
          ...
          <Modal.Body>
            <Form onSubmit={onSubmit}>
                  ...
                  <Fragment>
                    ...
                    <Col sm="9" className="padding-left">
                      <Form.Control
                        ...
                        size="sm"
                        name="extraHours"
                        value={extraHours === null ? 0 : extraHours}
                        onChange={(event) => setExtraHours(event.target.value)}
                        readOnly
                        id="total"
                      />
              ...
              <Button type="submit" className="submit-button" size="sm">
                Submit
              </Button>
            </Form>
          </Modal.Body>
...
export default AdminSalaryEdit;
