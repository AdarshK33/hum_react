...
const Address = (props) => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      if (stateValue !== null && stateValue !== undefined && Object.keys(stateValue).length !== 0) {
      ...
      if (permanentStatevalue!==null && permanentStatevalue!==undefined&& Object.keys(permanentStatevalue).length !== 0) {
  ...
  const submitHandler = (e) => {
    ...
    if (value === true) {
      ...
      const AddressInfo = {
        ...
        permanentAddressLine: isChecked ? null : state.permanentAddressLine,
        permanentAddressProof: null,
        permanentCityId: isChecked ? null : permanentCityId,
        permanentCountryId: isChecked ? null : permanentCountryId,
        permanentStateId: isChecked ? null : permanentStateId,
        permanentFlatNumber: isChecked ? null : state.permanentFlatNumber,
        permanentLocality: isChecked ? null : state.permanentLocality,
        permanentPhoneNumber: isChecked ? null : state.permanentPhoneNumber,
        permanentPinCode: isChecked ? null : state.permanentPinCode,
        permanentStreet: isChecked ? null : state.permanentStreet,
