              ...
              <Modal.Body className="appointmentLetter">
                ...
                <div className="mt-5 mb-5">
                  ...
                  <p>
                    ...
                    extended period as specified by your Manager. Thereafter,
                    your employment confirmation would be informed to you in
                    writing.
                  </p>
                  <p>
                    ...
                    Employee Compensation as specified in the respective
                    statutory acts. Please find the detailed breakup of salary
                    in Annexure1 enclosed below. Further, sufficient holidays
                    keep one motivated in a work environment. Therefore you
                    shall have{" "}
                    <b>
                      ...
                      <tr>
                        <td colSpan={8}>
                          <p>
                            ...
                            teammates from countries with whom India does not
                            have a Social Security Agreement (the countries not
                            ...
                            Security Agreement) can withdraw their Provident
                            Fund amount only after attaining the age of 58 years
                            (retirement age as fixed by the Government of
                            India).
                          </p>
                          <p>
                            * Please note that if you are drawing a monthly
                            gross salary upto 21000 then you would get a minimum
                            of INR. 583/per month for the number of months that
                            you have worked in any Financial year or a maximum
                            upto 0.0 % of your Monthly fixed gross basis the
                            criterion mentioned by your manager from time to
                            time
                          </p>
                          <p>
