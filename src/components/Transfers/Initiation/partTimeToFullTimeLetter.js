...
const PartTimeToFullTimeLetter = () => {
        ...
        <div className="appointmentLetter">
          ...
          <div className="mt-5 mb-5">
            ...
            <p>
              ...
              which will be at a maximum <b>{offerLetterData.bonus}</b>% of your
              gross monthly fixed compensation. You are entitled to all the
