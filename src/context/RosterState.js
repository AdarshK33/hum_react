...
export const RosterProvider = ({ children }) => {
  ...
  const viewShift = () => {
    setLoader(true);
    client
      .get("/api/v1/shift/view")
      .then(function (response) {
        // console.log("data==>" + JSON.stringify(response));
        state.shiftList = response.data.data;
        setLoader(false);
        return dispatch({
          type: "FETCH_SHIFT_LIST",
          payload: state.shiftList,
          loader: loader,
        });
      })
  ...
  const viewShiftPage = (page, size) => {
    ...
    client
      .get("/api/v1/shift/page?page=" + page + "&size=" + size)
      .then(function (response) {
        state.pageData = [];
        // console.log("data==>" + JSON.stringify(response));
        state.pageData = response.data.data;
        return dispatch({
          type: "FETCH_PAGESHIFT_LIST",
          payload: state.pageData,
        });
      })
      .catch(function (error) {
        console.log(error);
  ...
  function viewShiftTypes() {
    client
      ...
      .then(function (response) {
        ...
        return dispatch({
          type: "FETCH_SHIFT_LIST_NAMES",
          payload: state.shiftListNames,
        });
      })
      .catch(function (error) {
        console.log(error);
  ...
  function viewContractTypes() {
    client
      .get("/api/v1/contract_type/view")
      .then(function (response) {
        //console.log("data==>" + JSON.stringify(response));
        state.shiftContractNames = response.data.data;

        return dispatch({
          type: "FETCH_CONTRACT_LIST_NAMES",
          payload: state.shiftContractNames,
        });
      })
      .catch(function (error) {
        console.log(error);
  ...
  function updateShift(newEditShift) {
    return client
      .post("/api/v1/shift/update", newEditShift)
  ...
  const addShift = (newShift) => {
    return client
      .post("/api/v1/shift/create", newShift)
      .then(function (respone) {
        console.log("api response===", respone.data.message);
        toast.info(respone.data.message);
        viewShift();
  ...
  function deleteShift(shiftMasterId) {
    ...
    client
      .delete("/api/v1/shift/delete" + "?shiftId=" + shiftMasterId)
      .then(function (response) {
        console.log("data==>" + JSON.stringify(response));
  ...
  const weekOffDays = (weekId) => {
    ...
    // eslint-disable-next-line no-useless-concat
    client
      .get("/api/v1/weekoff/weeks/days" + "?weekId=" + weekId)
      .then((response) => {
  ...
  const addWeekOff = (newWeekOff) => {
    ...
    return client
      .post("/api/v1/weekoff/employee/create", newWeekOff)
      .then((response) => {
        const {
    ...
    client
      ...
      .then((response) => {
        ...
        return dispatch({
          ...
          payload: state.availableShiftData,
        });
      })
      .catch((error) => {
        console.log(error);
  ...
  const assignShift = (assignData) => {
    return client
      .post("/api/v1/shift/assign/employee", assignData)
      .then((response) => {
        const {
          selectedRosterRange: { endDate, startDate, empId },
        } = state;
  ...
  const getallWeeks = (date) => {
    ...
    client
      .get("/api/v1/weekoff/weeks?year=" + year)
      .then((response) => {
        ...
        return dispatch({
          type: "AVAILABLE_WEEKS",
          payload: state.weeksInYear,
        });
      })
      .catch((error) => {
        console.log(error);
  ...
  const uploadWeeks = (file) => {
    ...
    return client
      .post("/api/v1/weekoff/weeks/upload", formData)
      .then((response) => {
  ...
  const adminWeekOffDataEmp = (
    ...
    client
      ...
      .then((response) => {
        ...
        const adminSelectedRosterRange = {
          endDate,
          startDate,
          contract,
          weekid,
        ...
        return dispatch({
          type: "ADMIN_WEEKOFF_WEEK_DATA_LIST",
          payload: {
            adminWeekOffDataListHeader,
            adminWeekOffDataList,
            adminSelectedRosterRange,
  ...
  const rosterExport = (
    ...
    client
      .get(
        "/api/v1/roster/download?clusterId=" +
          clusterId +
          "&contractType=" +
          contract +
          "&endDate=" +
  ...
  const adminCalculateWeek = (endDate, startDate) => {
    ...
    client
      ...
      .then((response) => {
        ...
        return dispatch({
          type: "ADMIN_CALCULATE_AVAILABLE_WEEKS",
          payload: state.adminCalculateWeekResult,
        });
      })
      .catch((error) => {
        console.log(error);
  ...
  const adminRosterCalculateUtilisation = (storeId, month = 0, year = 2021) => {
    ...
    client
      ...
      .then((response) => {
        ...
        console.log(
          "admin calculate week ",
          state.adminRosterCalculateUtilisationList
        );
        return dispatch({
          type: "ADMIN_CALCULATE_UTILISATION",
          payload: state.adminRosterCalculateUtilisationList,
        });
      })
      .catch((error) => {
        console.log(error);
  ...
  const adminRosterUtilisationSchedule = (
    filterType,
    month,
    storeId,
    date = 0,
    ...
    client
      ...
      .then((response) => {
        ...
        console.log(
          "admin calculate week ",
          state.adminRosterUtilisationScheduleResult
        );
        return dispatch({
          type: "ADMIN_UTILISATION_SCHEDULE",
          payload: state.adminRosterUtilisationScheduleResult,
        });
      })
      .catch((error) => {
        console.log(error);
  ...
  const getEmployeeListForAdminRosterWeekOff = (
    contractType,
    storeId,
    clusterId
  ) => {
    ...
    client
      ...
      .then((response) => {
        ...
        console.log(
          "admin calculate week for store id  ",
          state.EmployeeListForAdminRosterWeekOff
        );
        return dispatch({
          type: "GET_ADMIN_EMPLOYEE_ROSTER_WEEK_OFF",
          payload: state.EmployeeListForAdminRosterWeekOff,
        });
      })
      .catch((error) => {
        console.log(error);
  ...
  const adminAddWeekOff = (newWeekOff) => {
    ...
    console.log("++++create weekOff api response+++++", newWeekOff);
    return client
      .post("/api/v1/weekoff/manager/create", newWeekOff)
      .then((response) => {
        const {
          adminSelectedRosterRange: {
            endDate,
  ...
  const adminRosterAvailableShift = (contractType, costCenter1) => {
    ...
    client
      ...
      .then((response) => {
        ...
        console.log(
          "admin calculate week ",
          state.adminRosterAvailableShiftList
        );
        //   alert(state.adminRosterAvailableShiftList);
        return dispatch({
          type: "ADMIN_ROSTER_AVAILABLE_SHIFT",
          payload: state.adminRosterAvailableShiftList,
        });
      })
      .catch((error) => {
        console.log(error);
  ...
  const assignAdminShift = (assignData) => {
    return client
      .post("/api/v1/shift/assign", assignData)
      .then((response) => {
        const {
          adminSelectedRosterRange: {
            endDate,
