...
export const ClusterProvider = ({ children }) => {
  ...
  const updateCluster = (updateCluter) => {
    return client
      .post("/api/v1/cluster/create", updateCluter)
  ...
  const addCluster = (addCluster) => {
    return client
      .post("/api/v1/cluster/create", addCluster)
      .then(function (respone) {
        console.log("api response===", respone.data.message);
        viewCluster();
        toast.info(respone.data.message);
  ...
  const viewCluster = () => {
    ...
    client
      .get("/api/v1/cluster/view?leader=" + flag)
  ...
  function selectEmployeeForCluster(storeId) {
    client
      .get("/api/v1/employee/view/" + storeId + "/cluster_employees")
      .then(function (response) {
        ...
        return dispatch({
          type: "FETCH_EMPLOYEE_FOR_CLUSTER",
          payload: state.getClusterEmployees,
        });
      })
      .catch(function (error) {
        console.log(error);
  ...
  const viewSports = () => {
    client
      ...
      .then(function (response) {
        ...
        return dispatch({
          type: "FETCH_SPORTS_NAME",
          payload: state.sportsNames,
        });
      })
      .catch(function (error) {
        console.log(error);
  ...
  const selectClusterLeader = (storeId) => {
    ...
    client
      .get("/api/v1/employee/view/" + storeId + "/cluster_leader")
      .then(function (response) {
        //    alert("Leaderes" + JSON.stringify(response));
        state.clusterLeaderNames = response.data.data;
        return dispatch({
          type: "FETCH_LEADERS_NAME",
          payload: state.clusterLeaderNames,
        });
      })
      .catch(function (error) {
        console.log(error);
  ...
  const selectAllClusterLeaderForEdit = (storeId) => {
    client
      .get("/api/v1/employee/view/" + storeId)
      .then(function (response) {
        state.clusterAllLeaderNames = response.data.data;
        return dispatch({
          type: "FETCH_ALL_LEADERS_NAME",
          payload: state.clusterAllLeaderNames,
        });
      })
      .catch(function (error) {
        console.log(error);
  ...
  function salaryEdit(salaryEdit, salaryData) {
    ...
    return client
      ...
      .then((response) => {
        ...
        return dispatch({ type: "EDIT_SALARY", payload: state.salaryList });
      })
      .catch((error) => {
        console.log(error);
      });
  ...
  const viewStoreSalary = (month, costCentre, year) => {
    ...
    client
      .get(
        "/api/v1/salary/view/store?month=" +
          month +
          "&storeId=" +
          costCentre +
          "&year=" +
  ...
  const viewClusterCostCenter = (costCenter) => {
    ...
    if (flag === "0") {
      ...
      return client
        .get("/api/v1/cluster/view/" + costCenter)
        .then((response) => {
  ...
  const viewClusterForAdmin = (storeId) => {
    client
      .get("/api/v1/cluster/view", storeId)
      .then(function (response) {
        //  console.log("data==>" + JSON.stringify(response));
        state.adminClusterList = response.data.data;
        console.log("==== ADMIN_CLUSTER LIST====");
        return dispatch({
          type: "FETCH_ADMIN_ClUSTER_LIST",
          payload: state.adminClusterList,
        });
      })
      .catch(function (error) {
        console.log(error);
  ...
  const viewCostCenterEmployeeByManger = (storeId) => {
    client
      .get("/api/v1/employee/view/" + storeId + "/cluster_employee")
      .then(function (response) {
        if (response.data.data === null) {
        ...
        return dispatch({
          type: "VIEW_COST_CENTER_EMPLOYEE_MANGER",
          payload: state.costCenterEmpAndMgrList,
        });
      })
      .catch(function (error) {
        console.log(error);
  ...
  const viewManagerByCostCenter = (storeId) => {
    client
      .get("/api/v1/employee/manager/" + storeId)
      .then(function (response) {
        if (response.data.data === null) {
        ...
        return dispatch({
          type: "VIEW_MANAGER_BY_COST_CENTER",
          payload: state.viewManagerByCostCenterList,
        });
      })
      .catch(function (error) {
        console.log(error);
  ...
  const callClusterEmployees = (storeId) => {
    ...
    client
      .get("/api/v1/employee/view/" + storeId + "/cluster")
      .then(function (response) {
        if (response.data.data === null) {
        ...
        return dispatch({
          type: "CLUSTER_EMP_LIST",
          payload: state.callClusterEmployeesList,
        });
      })
      .catch(function (error) {
        console.log(error);
  ...
  const callClusterLeaders = (storeId) => {
    ...
    client
      ...
      .then(function (response) {
        ...
        return dispatch({
          type: "CLUSTER_LEADERS_LIST",
          payload: state.callClusterLeadersList,
        });
      })
      .catch(function (error) {
        console.log(error);
