...
export const LeaveProvider = ({ children }) => {
  ...
  const headers = {
    ...
    Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhZG1pbmlzdHJhdG9yIiwiZXhwIjoxNTk4OTY4NTk3LCJpYXQiOjE1OTg5MzI1OTd9.GhqH-QYTS07yiNvDoe7fX_zz7hpX9LREGjoKaZFEg3M'
  }
  //View Leave
